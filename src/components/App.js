...
import './../styles/App.css'; // Assuming you have an App.css file for custom styles
          ...
          <div key={tour.id} className="tour-card">
            ...
            <div className="tour-details">
              ...
              <p className="tour-info">
                {showMore[tour.id] ? tour.info : `${tour.info.substring(0, 200)}...`}
              </p>
              <button onClick={() => toggleShowMore(tour.id)} className="toggle-button">
                {showMore[tour.id] ? "See less" : "Show more"}
              </button>
              <div className="tour-price">Price: ${tour.price}</div>
            </div>
          </div>
        ))}
      </div>
